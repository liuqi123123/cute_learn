...
using ElementCompute = float;
  static const int c =  32 / 16;
  using e_scale_s2g_copy_op = UniversalCopy<cutlass::AlignedArray<ElementCompute, 4>>;
  ...
  using e_scale_s2g_copy_tile = decltype(make_tiled_copy(
      e_scale_s2g_copy_atom{}, make_layout(Shape<Int<128 / c>,
