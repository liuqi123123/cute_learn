...
struct KernelTraits {
  ...
  using SmemLayoutQtransposedNoSwizzle = decltype(get_nonswizzle_portion(SmemLayoutQ{}));
  using SmemLayoutKtransposedNoSwizzle = decltype(get_nonswizzle_portion(SmemLayoutK{}));
...
// }
  ...
  Tensor smem_q_NoSwizzle = make_tensor(smem_q.data().get(), typename KernelTraits::SmemLayoutQtransposedNoSwizzle{});
  Tensor smem_k_NoSwizzle = make_tensor(smem_k.data().get(), typename KernelTraits::SmemLayoutKtransposedNoSwizzle{});
...
int main() {
  ...
  using KernelT = KernelTraits<cutlass::half_t, float, 8, 32, 32, 5>;
