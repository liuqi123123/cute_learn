...
struct KernelTraits {
  ...
  static constexpr int PaddingkMmaPN = kMmaPN;
  using SmemLayoutAtomC = decltype(composition(
      ...
      // Swizzle<2, 2, 3>{}, make_layout(make_shape(Int<kMmaPM>{}, Int<PaddingkMmaPN>{}), // 32 * 16
      // Swizzle<3, 1, 4>{}, make_layout(make_shape(Int<kMmaPM>{}, Int<PaddingkMmaPN>{}), // 32 * 16
      // Swizzle<0, 0, 0>{}, make_layout(make_shape(Int<kMmaPM>{}, Int<PaddingkMmaPN>{}), // 32 * 16
                                      make_stride(Int<PaddingkMmaPN>{}, Int<1>{})))); // 32 , 1

  using SmemLayoutC = decltype(tile_to_shape(
      SmemLayoutAtomC{},
      make_shape(Int<kMmaPM>{}, Int<PaddingkMmaPN>{}, Int<kSmemLayoutCBatch>{}))); // 32 16 1
  ...
  static const int EpiJoinThreadNum = Int<kMmaPM>{} * Int<kMmaPN>{} / AlignC;
